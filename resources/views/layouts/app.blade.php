...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>SnapHub - @yield('titulo')</title>
    ...
    <body class="bg-gray-100">
            ...
            <div class="container mx-auto flex justify-between items-center">
                ...
                @auth
                    <nav class="flex gap-2 items-center">
                        ...
                        {{-- Utilizo un formulario envés de un enlace para usar la directiva @csrf (tambien en el web.php uso el método POST, no GET) por seguridad --}}
        ...
        <footer class="mt-10 text-center p-5 text-gray-500 font-bold uppercase">
            SnapHub - Todos los derechos reservados
            {{ now()->year }}   <!-- Helper que me devuelve la fecha -->
        </footer>
